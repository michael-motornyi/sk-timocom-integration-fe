...
import VehicleSpaceOffersListControls from '@/components/VehicleSpaceOffersListControls';
import VehicleSpaceOffersContainer from '@/components/VehicleSpaceOffersContainer';

export default function VehicleSpacePage() {
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 via-white to-gray-100">
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 gap-6 mb-8">
          ...
          >
            <VehicleSpaceOffersListControls />
          </Suspense>
        </div>

        {/* Vehicle Space Offers Table */}
        <Suspense
          fallback={
